...
import divideAgreement from '@/views/divideAgreement'
import kyc1 from '@/views/kyc1'
...
import changeSure from '@/views/changeSure'
import changeSuccess from '@/views/changeSuccess'
import volunteerApply from '@/views/volunteerApply'
  ...
  routes: [
    {
      ...
      children:[
        ...
        { path:'/changePage', name:'changePage', component:changePage },
        ...
        { path:'/divideAgreement', name:'divideAgreement', component:divideAgreement },
        { path:'/kyc1', name:'kyc1', component:kyc1 },
        ...
        { path:'/changeSure', name:'changeSure', component:changeSure },
        { path:'/changeSuccess', name:'changeSuccess', component:changeSuccess },
        { path:'/volunteerApply', name:'volunteerApply', component:volunteerApply },
